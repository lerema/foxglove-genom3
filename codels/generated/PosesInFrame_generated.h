...
struct PosesInFrame FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  /// Poses in 3D space
  const flatbuffers::Vector<flatbuffers::Offset<Pose>> *poses() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Pose>> *>(VT_POSES);
  }
...
struct PosesInFrameBuilder {
  ...
  void add_poses(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Pose>>> poses) {
  ...
  PosesInFrameBuilder &operator=(const PosesInFrameBuilder &);
...
inline flatbuffers::Offset<PosesInFrame> CreatePosesInFrame(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Pose>>> poses = 0) {
...
inline flatbuffers::Offset<PosesInFrame> CreatePosesInFrameDirect(
    ...
    const std::vector<flatbuffers::Offset<Pose>> *poses = nullptr) {
  auto frame_id__ = frame_id ? _fbb.CreateString(frame_id) : 0;
  auto poses__ = poses ? _fbb.CreateVector<flatbuffers::Offset<Pose>>(*poses) : 0;
