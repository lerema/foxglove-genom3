...
struct Grid FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Vector2 *cell_size() const {
    return GetPointer<const Vector2 *>(VT_CELL_SIZE);
  }
  ...
  const flatbuffers::Vector<flatbuffers::Offset<PackedElementField>> *fields() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<PackedElementField>> *>(VT_FIELDS);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_ROW_STRIDE) &&
           VerifyField<uint32_t>(verifier, VT_CELL_STRIDE) &&
...
struct GridBuilder {
  ...
  void add_cell_size(flatbuffers::Offset<Vector2> cell_size) {
  ...
  void add_fields(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<PackedElementField>>> fields) {
  ...
  GridBuilder &operator=(const GridBuilder &);
...
inline flatbuffers::Offset<Grid> CreateGrid(
    ...
    flatbuffers::Offset<Vector2> cell_size = 0,
    uint32_t row_stride = 0,
    uint32_t cell_stride = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<PackedElementField>>> fields = 0,
...
inline flatbuffers::Offset<Grid> CreateGridDirect(
    ...
    uint32_t row_stride = 0,
    uint32_t cell_stride = 0,
    const std::vector<flatbuffers::Offset<PackedElementField>> *fields = nullptr,
    const std::vector<uint8_t> *data = nullptr) {
  auto frame_id__ = frame_id ? _fbb.CreateString(frame_id) : 0;
  auto fields__ = fields ? _fbb.CreateVector<flatbuffers::Offset<PackedElementField>>(*fields) : 0;
