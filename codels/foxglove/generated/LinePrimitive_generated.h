...
enum LineType {
  ...
  LineType_LINE_STRIP = 0  /// Closed polygon: 0-1, 1-2, ..., (n-1)-n, n-0
,
  LineType_LINE_LOOP = 1  /// Individual line segments: 0-1, 2-3, 4-5, ...
,
...
inline const char *EnumNameLineType(LineType e) {
  if (e < LineType_LINE_STRIP || e > LineType_LINE_LIST) return "";
...
struct LinePrimitive FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  LineType type() const {
    return static_cast<LineType>(GetField<uint8_t>(VT_TYPE, 0));
  }
...
struct LinePrimitiveBuilder {
  ...
  LinePrimitiveBuilder &operator=(const LinePrimitiveBuilder &);
...
inline flatbuffers::Offset<LinePrimitive> CreateLinePrimitive(
    ...
    LineType type = LineType_LINE_STRIP,
