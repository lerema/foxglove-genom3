...
struct ModelPrimitive FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Vector3 *scale() const {
    return GetPointer<const Vector3 *>(VT_SCALE);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_OVERRIDE_COLOR) &&
...
struct ModelPrimitiveBuilder {
  ...
  void add_scale(flatbuffers::Offset<Vector3> scale) {
  ...
  ModelPrimitiveBuilder &operator=(const ModelPrimitiveBuilder &);
...
inline flatbuffers::Offset<ModelPrimitive> CreateModelPrimitive(
    ...
    flatbuffers::Offset<Vector3> scale = 0,
